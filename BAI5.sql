...
WHERE 
    enrollments.enrollment_date BETWEEN '2025-01-12' AND '2025-01-18'
...
JOIN 
    courses ON enrollments.course_id = courses.course_id
WHERE 
    courses.fee < 1000000 OR courses.course_name != 'Python Basics'
LIMIT 5;
...
JOIN 
    courses ON enrollments.course_id = courses.course_id
WHERE 
    courses.course_name = 'Web Development' OR courses.course_name = 'Data Science'
ORDER BY
    enrollments.enrollment_date ASC
LIMIT 3;
